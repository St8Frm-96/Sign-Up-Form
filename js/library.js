let library;
const DEFAULT_DATA = [
    { name: "I'd Like to Play Alone, Please", author: "Tom Segura", status: "not read" },
    { name: "Awakened: A Novel", author: "James S. Murray", status: "read" },
    { name: "The Witcher: The Last Wish", author: "Andrzej Sapkowski", status: "not read" },
];
